...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/hmoTEAM/Files_hmo/master/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevhmoW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevhmoW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevhmoW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevhmoW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevhmoW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevhmoW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevhmoW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
--------------------------------------------------------------------------------------------------------------
function Sourcehmo(msg,data) -- بداية العمل
if msg then
...
if DevhmoW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,hmo_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ⌔' and DevhmoW(msg) then  
...
if text == 'تعطيل التواصل ⌔' and DevhmoW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌔' and DevhmoW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌔' and DevhmoW(msg) then  
...
if text == 'ضع كليشه ستارت ⌔' and DevhmoW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ⌔︙ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ⌔' and DevhmoW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ⌔︙ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ⌔' and DevhmoW(msg) then 
...
if text == 'تحديث السورس ⌔' and DevhmoW(msg) then 
os.execute('rm -rf hmo.lua')
os.execute('wget https://raw.githubusercontent.com/hmo/hmo/master/hmo.lua')
send(msg.chat_id_, msg.id_,' ⌔︙ تم تحديث السورس \n ⌔︙ لديك اخر اصدار لسورس حمو\n ⌔︙ الاصدار » { 1.3v}')
dofile('hmo.lua')  
end
if text == 'الاصدار ⌔' and DevhmoW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌔︙ اصدار سورس حمو \n ⌔︙ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ⌔' and DevhmoW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌔︙ [تحديثات البوت](t.me/EYYDV) \n ⌔︙ [قناه السورس](t.me/EYYDV)')
end
if text == "ضع اسم للبوت ⌔" and DevhmoW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ⌔︙ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ⌔' and DevhmoW(msg) then 
...
if text == 'المشتركين ⌔' and DevhmoW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ⌔︙ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌔' and DevhmoW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ⌔︙ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌔") and DevhmoW(msg) then
...
if text == ("قائمه العام ⌔") and DevhmoW(msg) then
...
if text == ("قائمه الكتم العام ⌔") and DevhmoW(msg) then
...
if text=="اذاعه خاص ⌔" and msg.reply_to_message_id_ == 0 and DevhmoW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌔︙ ارسل الان اذاعتك؟ \n ⌔︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ⌔" and msg.reply_to_message_id_ == 0 and DevhmoW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌔︙ ارسل الان اذاعتك؟ \n ⌔︙ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ⌔" and msg.reply_to_message_id_ == 0 and DevhmoW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌔︙ ارسل الان اذاعتك؟ \n ⌔︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ⌔" and msg.reply_to_message_id_ == 0  and DevhmoW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌔︙ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌔" and msg.reply_to_message_id_ == 0  and DevhmoW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌔︙ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌔' and DevhmoW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌔" and DevhmoW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌔" and DevhmoW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'⌔︙  عدد الكروبات الان » { '..#group..' }'..hmok..''..hmo..'\n⌔︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevhmoW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevhmoW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevhmoW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevhmoW(msg) then
...
local hmo1_Msg = database:get(bot_id.."hmo1:Add:Filter:Rp2"..text..msg.chat_id_)   
if hmo1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if hmo_Msg and not Special(msg) then  
local hmo_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if hmo_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevhmoW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevhmoW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevhmoW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⌔︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevhmoW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⌔︙ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ⌔" and DevhmoW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ⌔︙ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌔$") and DevhmoW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⌔︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌔" and DevhmoW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌔" and DevhmoW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ⌔︙ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ⌔" and DevhmoW(msg) then  
...
database:sadd(bot_id.."hmo:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."hmo:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_hmo = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_hmo then 
names_hmo = database:smembers(bot_id.."hmo:blocname"..msg.chat_id_) or ""
if names_hmo and names_hmo[1] then 
for i=1,#names_hmo do 
if name_hmo:match("(.*)("..names_hmo[i]..")(.*)") then 
...
database:set(bot_id.."hmo:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."hmo:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."hmo:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."hmo:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."hmo:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_hmoa_new(hmo1,hmo2)
if hmo2 and hmo2.first_name_ then 
if hmo2.first_name_:match("(.*)"..database:get(bot_id.."hmo:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."hmo:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local hmo_nnn = database:get(bot_id.."hmo:nump"..msg.chat_id_) or 5
local hmo_nnn2 = database:get(bot_id.."hmo:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(hmo_nnn2) == tonumber(hmo_nnn) or tonumber(hmo_nnn2) > tonumber(hmo_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."hmo:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌔︙ عزيزي >>["..hmo2.username_.."](https://t.me/"..(hmo2.username_ or "EYYDV")..")\n⌔︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."hmo:teh"..msg.chat_id_).."} بجانب اسمك\n⌔︙ عدد المحاولات المتبقيه {"..(tonumber(hmo_nnn) - tonumber(hmo_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_hmoa_new)
end
end
...
local hmoChengName = database:get(bot_id.."hmo:Cheng:Name"..data.id_)
if not data.first_name_ then 
if hmoChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..hmoChengName..']')
database:del(bot_id.."hmo:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if hmoChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."hmo:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local hmoChengUserName = database:get(bot_id.."hmo:Cheng:UserName"..data.id_)
if not data.username_ then 
if hmoChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..hmoChengUserName..']')
database:del(bot_id.."hmo:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if hmoChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."hmo:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local hmoChengPhoto = database:get(bot_id.."hmo:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if hmoChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."hmo:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if hmoChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."hmo:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevhmoW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevhmoW(msg) then    
dofile('hmo.lua')  
send(msg.chat_id_, msg.id_, ' ⌔︙ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevhmoW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevhmoW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevhmoW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevhmoW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevhmoW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevhmoW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevhmoW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevhmoW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevhmoW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevhmoW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevhmoW(msg) then
...
if text == 'الملفات' and DevhmoW(msg) then
t = ' ⌔︙ ملفات السورس حمو ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevhmoW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/hmoTEAM/Files_hmo/master/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevhmoW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/hmoTEAM/Files_hmo/master/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevhmoW(msg) then
...
if text == "مسح الملفات" and DevhmoW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ⌔︙ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevhmoW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevhmoW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_hmo(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_hmo, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_hmo, nil)
return false 
end
...
database:set(bot_id.."hmo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."hmo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ⌔︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."hmo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."hmo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."hmo1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."hmo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ⌔︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."hmo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."hmo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."hmo1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."hmo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ⌔︙ ارسل الكلمه الان")  
database:set(bot_id.."hmo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."hmo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."hmo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."hmo1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."hmo1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."hmo1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."hmo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."hmo1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."hmo1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ⌔︙ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local hmo_Msg = database:get(bot_id.."hmo1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..hmo_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevhmoW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ⌔︙ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevhmoW(msg) then
...
if text == 'تفعيل الاذاعه' and DevhmoW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevhmoW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..hmo_Msg[math.random(#hmo_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevhmoW(msg) then 
...
if text == ("مسح ردود المطور") and DevhmoW(msg) then 
...
if text == ("ردود المطور") and DevhmoW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌔︙ قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevhmoW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevhmoW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevhmoW(msg) then   
...
if text == 'تعطيل المغادره' and DevhmoW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌔︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'hmo')..') '
...
-- vardump(data) 
hmodx(msg.chat_id_, msg.id_, ' ⌔︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ⌔︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ⌔︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ⌔︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevhmoW(msg) then
...
zh = https.request('https://rudi-dev.tk/Amir1/hmo.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n⌔︙ قائمه الزخرفه \nٴ⌔︙ٴ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ٴ⌔︙○ٴ \n"
i = 0
...
gk = https.request('https://rudi-dev.tk/Amir2/hmo.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/hmo.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
hmo = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(hmo)
...
------------------------------------------------------------------------
local hmoAbot = database:get(bot_id.."hmo1:Add:Filter:Rp2"..text..result.chat_id_)   
if hmoAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌔︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌔︙ ["..hmoAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local hmo1_Msg = database:get(bot_id.."hmo1:Add:Filter:Rp2"..text..result.chat_id_)   
if hmo1_Msg then    
send(msg.chat_id_, msg.id_," ⌔︙ "..hmo1_Msg)
